...
class TestRectangle(unittest.TestCase):
    ...
    def test_height_typerror(self):
        """Test not int for height"""
    ...
    def test_update_too_many_args(self):
        """Test update too many args for update"""
        r = Rectangle(1, 1, 0, 0, 1)
        r.update(1, 1, 1, 1, 1, 2)
        self.assertEqual(str(r), "[Rectangle] (1) 1/1 - 1/1")

    def test_update_no_args(self):
        """Test update no args for update"""
        r = Rectangle(1, 1, 0, 0, 1)
        r.update()
        self.assertEqual(str(r), "[Rectangle] (1) 0/0 - 1/1")

    def test_mix_args_kwargs(self):
        """Test output for mixed args and kwargs"""
        r = Rectangle(1, 1, 0, 0, 1)
